                ...
                >
                    {steps.map((step, index) => (
                        <motion.div
                            ...
                            className="group relative bg-white/5 border border-white/10 rounded-3xl overflow-hidden flex flex-col hover:border-[#FF5733]/30 transition-colors duration-500"
                        >
                            <div className="p-8 flex flex-col h-full relative z-10">
                                {/* Icon Badge */}
                                <div className="mb-6 w-14 h-14 rounded-2xl bg-[#FF5733]/10 border border-[#FF5733]/20 flex items-center justify-center text-3xl shadow-[0_0_15px_rgba(255,87,51,0.1)] group-hover:shadow-[0_0_25px_rgba(255,87,51,0.2)] transition-shadow duration-500">
                                    {step.icon}
                                </div>
